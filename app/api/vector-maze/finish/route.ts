...
import { GameFinishRequest, GameFinishResponse, VectorMazeGameData } from '@/types/api';
...
export async function POST(request: NextRequest) {
  try {
    ...
    await updateVectorMazeSession(validatedData.gameId, finishedGameData, scoreResult.score);
